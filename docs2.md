...
How it works
Environment variables
Refer to the Environment Variables page.
...
vector.yaml
sources/apache_logs.yaml
transforms/apache_parser.yaml
transforms/apache_sampler.yaml
sinks/es_cluster.yaml
sinks/s3_archives.yaml
# Set global options
data_dir: "/var/lib/vector"
